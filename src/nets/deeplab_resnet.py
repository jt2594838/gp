# ref: https://github.com/isht7/pytorch-deeplab-resnet/blob/master/deeplab_resnet.py
import numpy as np
import torch
...
class MS_Deeplab(nn.Module):
    ...
    def forward(self, x):
        input_size = x.size()[2]
        self.interp1 = nn.Upsample(size=(int(input_size * 0.75) + 1, int(input_size * 0.75) + 1))
        self.interp2 = nn.Upsample(size=(int(input_size * 0.5) + 1, int(input_size * 0.5) + 1))
