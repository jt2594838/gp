...
parser.add_argument('-model_path', type=str, default='/home/jt/codes/bs/gp/res_anzhen/original_model/ResNet101_anzhen_3_200_98.35051569987819.pkl')
...
parser.add_argument('-gen_method_name', type=str, default='super_pixel_zero')
